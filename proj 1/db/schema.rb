...
ActiveRecord::Schema.define(version: 20160904140624) do
  ...
  add_index "solutions", ["theme_id"], name: "index_solutions_on_theme_id", using: :btree
  ...
  add_foreign_key "solutions", "themes"
